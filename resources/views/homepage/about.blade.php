...
<div class="bg bg-black">
   @section('content')
      <div>
         <div class="hero bg-black">
               <div class="hero-content flex-col lg:flex-row-reverse mt-20">
                  ...
                  <div>
                     ...
                     <p class="py-6 text-white mr-20 text-2xl">Netflix adalah layanan streaming yang menawarkan berbagai
                           acara
                           TV pemenang penghargaan, film, anime, dokumenter, dan banyak lagi di ribuan perangkat yang
                           terhubung
                           ke Internet.</p>
                  </div>
         ...
         <div class="card bg-black shadow-xl mt-5">
               <figure class="">
